...
print('普通道具的抽数累进分布', gg.FiniteDist(gacha_system.get_type_distribution(type=1)).cdf)
...
print('武器池普通道具的抽数累进分布', gg.FiniteDist(gacha_system.get_type_distribution(type=1)).cdf)
